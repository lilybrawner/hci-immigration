...
export const pcChecklist = {
    ...
    4: [
        { section: 'Step 4: Begin NVC Processing' },
        ...
        { id: 4.101, label: "The NVC will require payment of two fees: the Immigrant Visa Application Processing Fee and the Affidavit of Support Fee. Together these total $445 in most cases ( $325 + $120, though amounts can change – refer to the fee information on CEAC).", checked: false, nested: true },
    ...
    6: [
        ...
        { section: 'Step 6: Submit Visa Application (DS-260)' },
        ...
        { id: 6.101, label: "If you, the petitioner, are completing it on their behalf, make sure the answers are accurate to your parent’s knowledge.", checked: false, nested: true },
        ...
        { id: 6.201, label: "Address history: last five addresses and how long lived there.", checked: false },
    ...
    8: [
        ...
        { id: 8.201, label: "Petitioner’s Birth Certificate (your birth certificate, to prove relationship)", checked: false },
    ...
    10: [
        ...
        { id: 10.101, label: "The consular officer may ask about the petitioner’s ability to support. It’s not always requested if NVC qualified it, but carrying a set of the financials (tax returns, job letter, etc.) is wise in case.", checked: false, nested: true },
        ...
        { id: 10.201, label: "The officer may also ask about the petitioner’s job or where they live in the U.S., to gauge that the parent has thought about their move. These are usually straightforward.", checked: false, nested: true },
        ...
        { id: 10.301, label: "Petitioner’s proof of citizenship: e.g., original U.S. birth cert or naturalization certificate of the child (for consular interview). For AOS, the officer might ask to see petitioner’s ID or citizenship proof as well, so have it if attending.", checked: false },
    ...
    12: [
        ...
        { id: 12.101, label: 'Name/Info: If there’s any error on the card (spelling, DOB), you’ll need to file for a replacement (Form I-90) to correct it. Double-check the card upon receipt.', checked: false },
